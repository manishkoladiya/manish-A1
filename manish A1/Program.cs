...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("- Interact with your pet by choosing actions.");
        Console.WriteLine("- Feed your pet to reduce hunger and increase happiness.");
        Console.WriteLine("- Play with your pet to increase happiness.");
        Console.WriteLine("- Rest your pet to increase health and decrease happiness.");
        Console.WriteLine("- Keep an eye on your pet's stats and warnings.");
